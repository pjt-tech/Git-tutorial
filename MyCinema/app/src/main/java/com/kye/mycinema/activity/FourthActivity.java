...
public class FourthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.evil_drawer);
        ...
        NavigationView navigationView = findViewById(R.id.evil_drawerView);
        ...
        MyListAdapter myAdapter3 = new MyListAdapter(this);

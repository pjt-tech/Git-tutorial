...
public class ThirdActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.king_drawer);
        ...
        NavigationView navigationView = findViewById(R.id.king_drawerView);
        ...
        MyListAdapter myAdapter2 = new MyListAdapter(this);

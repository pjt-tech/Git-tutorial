...
public class FifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.luck_drawer);
        ...
        MyListAdapter myAdapter4 = new MyListAdapter(this);
        listView.setAdapter(myAdapter4);

        NavigationView navigationView = findViewById(R.id.luck_drawerView);
